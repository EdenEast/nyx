...
opt.number         = false                -- dont show numbers by default. if I need it I can toggle with maps
opt.relativenumber = false                -- dont show relnumbers by default. if I need numbers I can toggle with maps
opt.signcolumn     = 'no'                 -- always show sign column. currently there is a visual desync when this is auto. (#14195)
