...
function config.harpoon()
  ...
  nnoremap { '<leader>hi', function() require('harpoon.ui').nav_file(3) end }
  nnoremap { '<leader>ho', function() require('harpoon.ui').nav_file(4) end }

  -- 'jkl;' are the homerow keys for qwerty
  nnoremap { '<leader>hj', function() require('harpoon.ui').nav_file(1) end }
  nnoremap { '<leader>hk', function() require('harpoon.ui').nav_file(2) end }
  nnoremap { '<leader>hl', function() require('harpoon.ui').nav_file(3) end }
  nnoremap { '<leader>h;', function() require('harpoon.ui').nav_file(4) end }

  nnoremap { '<leader>ht', function() require('harpoon.term').gotoTerminal(1) end }
end
