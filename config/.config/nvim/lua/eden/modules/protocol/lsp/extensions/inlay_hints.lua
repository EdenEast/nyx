-- This is taken from https://github.com/nvim-lua/lsp_extensions.nvim/blob/4011f4a/lua/lsp_extensions/inlay_hints.lua
-- I only needed the inlay hints part of the extension. I may modify this in the future
...
local inlay_hints_ns = vim.api.nvim_create_namespace("eden.lsp.inlay_hints")
