...
function Theme.hook()
  if vim.g.colors_name then vim.fn.writefile({ vim.g.colors_name }, cache) end
end

function Theme.read_cache() return path.exists(cache) and vim.fn.readfile(cache)[1] or default end
