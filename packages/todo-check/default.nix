_: {
  perSystem = {
    ...
    packages = {
      todo-check = pkgs.writeShellApplication {
        name = "todo-check";
        text = let
        ...
        in
          # Modified from https://github.com/pinpox/nixos/blob/9ba9ea0807eec22fe17a690d160b65601fd1fe10/.github/workflows/check-upstream-todos.yml
          # bash
          ''
            set -e
